...
Demo short track - FirstMIDI.mp3 is a quick demo of the sound of ESP-909, straight after getting MIDI to work. In the track it's controlling a sequence on my Roland JU-06A. Recorded live to a Zoom R8 with no EQ. Synth line - Korg X5DR  :)
